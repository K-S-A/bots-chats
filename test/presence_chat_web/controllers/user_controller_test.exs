defmodule PresenceChatWeb.UserControllerTest do
  use PresenceChatWeb.ConnCase

  alias PresenceChat.Accounts

  @create_attrs %{email: "some email", encrypted_password: "some encrypted_password", first_name: "some first_name", last_name: "some last_name", nickname: "some nickname"}
